        ...
        <main className="flex-1 overflow-auto">
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="lg:hidden mb-4">
              <p className="text-sm text-slate-500">Logged in as <span className="font-medium text-slate-700">{admin?.email}</span></p>
            </div>
                  ...
                  {leads.length === 0 ? (
                    <div className="py-16 text-center">
                      ...
                      <p className="text-slate-400 text-sm mt-1">
                        {search ? 'Try adjusting your search query' : 'Leads will appear here once submitted'}
                      </p>
                    </div>
                  ) : (
